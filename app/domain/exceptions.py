...
class PrelabRequired(DomainError):
    ...
    def __init__(self, message: str = "Wymagane jest zaliczenie testu pre-lab.") -> None:
        super().__init__(message)
...
class TokenBudgetExceeded(DomainError):
    ...
    def __init__(self, message: str = "Wyczerpano budżet tokenów dla bieżącej sesji.") -> None:
        super().__init__(message)
